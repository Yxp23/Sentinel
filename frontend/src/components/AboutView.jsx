...
const FLOW_STEPS = [
  ...
  { label: 'Case Files',      icon: '📁', color: 'var(--text)',  sub: '200 investigations' },
]
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}
      ...
      <div style={{ maxWidth: 960, margin: '0 auto 56px' }}>
        <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 10, letterSpacing: '0.2em', color: 'var(--dim)', textTransform: 'uppercase', marginBottom: 18, textAlign: 'center' }}>
          Live Investigation Demo
        </div>
        <div className="nm-inset" style={{ padding: '24px 28px', borderRadius: 16 }}>
          <InvestigationDemo />
        </div>
      </div>
